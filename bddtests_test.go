...
func FeatureContext(s *godog.Suite) {
	...
	context, err := NewBDDContext([]string{"peerorg1", "peerorg2"}, "orderer.example.com", "./fixtures/clientconfig/",
		"config.yaml", peersMspID, "../build/skcc", "./fixtures/testdata")
	if err != nil {
	...
	NewDCASSteps(context).RegisterSteps(s)
}
